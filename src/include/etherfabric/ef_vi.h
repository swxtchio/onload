...
#define EF_REQUEST_ID_MASK 0xffffffff
  ...
  */
  typedef union
  {
    ...
    struct
    { /* This *must* have same initial layout as [rx]. */
      unsigned type : 16;
      unsigned q_id : 8;
      unsigned __reserved : 8;
      unsigned rq_id : 32;
    ...
    struct
    { /* This *must* have same layout as [tx]. */
      unsigned type : 16;
      unsigned q_id : 8;
      unsigned flags : 8;
      unsigned desc_id : 16;
    ...
    struct
    { /* This *must* have same layout as [tx] up to [flags]. */
      unsigned type : 16;
      unsigned q_id : 8;
      unsigned flags : 8;
      unsigned rq_id : 32;
    ...
    ** using a doorbell */
    ...
    struct ops
    {
      ...
      **  of packet buffers */
      ...
      void (*ev_fill_pkt)(struct ef_vi *vi, char *output_buffer, int event_index);
      void (*tx_fill_pkt)(struct ef_vi *vi, const char *output_buffer, const unsigned len);
...
#define ef_vi_transmit_memcpy_sync(vi, dma_id) \
  ...
  */
  ...
  extern int efdpdk_ef_eventq_check_event(const ef_vi *vi);
  ...
  */
  ...
  ef_eventq_has_event(const ef_vi *vi)
  {
    ...
    case EF_VI_ARCH_DPDK:
      return efdpdk_ef_eventq_check_event(vi);
#endif
...
/*!
 */
#define ef_fill_ev_data(evq, pkt, index) (evq)->ops.ev_fill_pkt((evq), (pkt), (index))
#define ef_fill_tx_data(evq, pkt, len) (evq)->ops.tx_fill_pkt((evq), (pkt), (len))
