...
#else
#define CI_TP_LOG_DEFAULT (CI_TP_LOG_E | CI_TP_LOG_U | CI_TP_LOG_TE | CI_TP_LOG_NT)
#endif
...
#define OOFA_IPCACHE_STATUS(s) ((s) == retrrc_success ? "Onloaded" : (s) == retrrc_nomac    ? "NoMac"   \
