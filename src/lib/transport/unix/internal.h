...
#endif
  enum onload_delegated_send_rc (*dsend_prepare)(citp_fdinfo *, int size, unsigned flags,
...
extern int citp_dpdk_init(void) CI_HF;
...
#define fdip_to_waiter(fdip) ((citp_fdtable_waiter *)(ci_uintptr_t)((fdip) & ~(fdip_busy)))
