...
#define dma_wmb() __asm__ __volatile__("" \
                                       :  \
                                       :  \
                                       : "memory")
#define smp_rmb() __asm__ __volatile__("lfence" \
                                       :        \
                                       :        \
                                       : "memory")
...
#define wmb() __asm__ __volatile__("sync" \
                                   ...
                                   :      \
                                   : "memory")
#define wmb_wc() __asm__ __volatile__("sync" \
                                      :      \
                                      :      \
                                      : "memory")
#define mmiowb() __asm__ __volatile__("sync" \
                                      :      \
                                      :      \
                                      : "memory")
#define dma_wmb() __asm__ __volatile__("sync" \
                                       :      \
                                       :      \
                                       : "memory")
#define smp_rmb() __asm__ __volatile__("lwsync" \
                                       :        \
                                       :        \
                                       : "memory")
...
#define wmb() __asm__ __volatile__("dsb st" \
                                   ...
                                   :        \
                                   : "memory")
#define wmb_wc() __asm__ __volatile__("dsb oshst" \
                                      :           \
                                      :           \
                                      : "memory")
#define mmiowb() \
...
#define dma_wmb() __asm__ __volatile__("dsb oshst" \
                                       :           \
                                       :           \
                                       : "memory")
#define smp_rmb() __asm__ __volatile__("dmb ishld" \
                                       :           \
                                       :           \
                                       : "memory")
