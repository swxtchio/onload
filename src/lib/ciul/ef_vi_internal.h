...
#define EF_VI_BUILD_ASSERT(e)                                                                   \
  {                                                                                             \
    __attribute__((__unused__)) typedef char __EF_VI_BUILD_ASSERT_NAME(__LINE__)[(e) ? 1 : -1]; \
  }
...
#define __EFVI_MASKFIELD32(LBN, WIDTH) ((uint32_t)(__EFVI_MASK32(WIDTH) << (LBN)))

/* constructors for fields which span the first and second dwords */
#define __LW(LBN) (32 - LBN)
#define LOW(v, LBN, WIDTH) ((uint32_t)(((v)&__EFVI_MASK64(__LW((LBN)))) << (LBN)))
...
#define LOW2(v, LBN, WIDTH) ((uint32_t)(((v)&__EFVI_MASK64(__LW2((LBN)))) << ((LBN)-32)))
#define HIGH2(v, LBN, WIDTH) ((uint32_t)(((v) >> __LW2((LBN))) & __EFVI_MASK64((WIDTH - __LW2((LBN))))))
...
#define LOW3(v, LBN, WIDTH) ((uint32_t)(((v)&__EFVI_MASK64(__LW3((LBN)))) << ((LBN)-64)))
#define HIGH3(v, LBN, WIDTH) ((unit32_t)(((v) >> __LW3((LBN))) & __EFVI_MASK64((WIDTH - __LW3((LBN))))))
...
extern void efdpdk_vi_init(ef_vi *) EF_VI_HF;
